...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Cita.url_act'
        db.alter_column('cita_cita', 'url_act', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

        # Changing field 'Cita.fecha_act'
        db.alter_column('cita_cita', 'fecha_act', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'Cita.fecha_baja'
        db.alter_column('cita_cita', 'fecha_baja', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'Cita.url_baja'
        db.alter_column('cita_cita', 'url_baja', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

    def backwards(self, orm):

        # Changing field 'Cita.url_act'
        db.alter_column('cita_cita', 'url_act', self.gf('django.db.models.fields.CharField')(default=None, max_length=20))

        # Changing field 'Cita.fecha_act'
        db.alter_column('cita_cita', 'fecha_act', self.gf('django.db.models.fields.DateTimeField')(default=None))

        # Changing field 'Cita.fecha_baja'
        db.alter_column('cita_cita', 'fecha_baja', self.gf('django.db.models.fields.DateTimeField')(default=None))

        # Changing field 'Cita.url_baja'
        db.alter_column('cita_cita', 'url_baja', self.gf('django.db.models.fields.CharField')(default=None, max_length=20))
    ...
    models = {
        'cita.cita': {
            ...
            'fecha_act': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
            'fecha_alta': ('django.db.models.fields.DateTimeField', [], {}),
            'fecha_baja': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
            ...
            'url_act': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True'}),
            'url_alta': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'url_baja': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True'}),
