...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Cita.tipo_habitacional'
        db.alter_column('cita_cita', 'tipo_habitacional', self.gf('django.db.models.fields.CharField')(max_length=20))

    def backwards(self, orm):

        # Changing field 'Cita.tipo_habitacional'
        db.alter_column('cita_cita', 'tipo_habitacional', self.gf('django.db.models.fields.CharField')(max_length=10))
    ...
    models = {
        'cita.cita': {
            ...
            'tipo_habitacional': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
